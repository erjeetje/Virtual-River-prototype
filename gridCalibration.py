...
def detectCorners(filename):
    ...
    #cv2.imwrite('CirclesDetected_real_gray.jpg', gray) # store grayscale image
    ...
    #cv2.imwrite('CirclesDetected_real_threshold.jpg', thresh) # store threshold image
...
def rotateGrid(canvas, img):
    ...
    pts2 = np.float32([[0,0],[img_x,0],[0,img_y],[img_x,img_y]]) # size for warped image
    ...
    origins, radius = calcGrid(img_y, img_x)
