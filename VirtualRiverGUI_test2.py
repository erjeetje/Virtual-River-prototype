...
class GUI(QWidget):
    ...
    def initUI(self):
        ...
        self.btn_elevation.move(10, 250)
        ...
        self.btn_roughness.move(10, 410)
        ...
        self.btn_ownership.move(10, 490)
        ...
        self.btn_round.move(10, 640)
        self.lbl_facilitator = QLabel('Facilitator controls', self)
        self.lbl_facilitator.move(10, 800)
        ...
        self.btn_initialize.move(10, 840)
        ...
        self.btn_reload.move(10, 920)
        self.lbl_feedback = QLabel('I am doing stuff', self)
        self.lbl_feedback.move(10, 1020)
        self.lbl_feedback.setFixedWidth(180)
...
class Thread(QThread):
    ...
    def run(self):
        ...
        #self.script.moveToThread(self.worker_thread)
...
class Feedback(QDialog):
    def __init__(self, parent):
        ...
        self.resize(250, 150)
        self.center()
        self.lbl_feedback = QLabel("Initiating update", self)
        self.lbl_feedback.move(25, 50)
        self.lbl_feedback.setFixedWidth(200)
        self.lbl_feedback.setAlignment(Qt.AlignCenter)
        self.lbl_timer = QLabel("Around 30 seconds remaining", self)
        self.lbl_timer.move(25, 100)
...
class runScript(QThread):
    ...
    def initialize(self, gui, feedback):
        ...
        self.tygron_login()
        feedback.set_feedback_text('Calibrating board')
        self.get_image()
        """
